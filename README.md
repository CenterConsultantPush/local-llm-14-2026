<!-- seo-unique:local-llm-14-2026:3372eec316 -->

<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:10B981,50:059669,100:047857&height=140&section=header&text=Local Llm 14 2026&fontSize=38&fontColor=fff&animation=twinkling" alt="Local Llm 14 2026" width="100%">
</p>
...
<p align="center">
  <a href="./releases/latest">
    <img src="https://img.shields.io/badge/📥_СКАЧАТЬ-local-llm-14-2026.exe-059669?style=for-the-badge&labelColor=1a1a2e" alt="Download">
  </a>
  &nbsp;
...
```mermaid
flowchart LR
  A[📥 Скачать local-llm-14-2026.exe] --> B[▶ Двойной клик]
  B --> C[🤖 Локальный чат]
```

1. **Двойной клик** по **`local-llm-14-2026.exe`** в корне репозитория — или запустите **`START.bat`**
2. Либо **[Releases → Latest](./releases/latest)** — тот же **`local-llm-14-2026.exe`**
...
- **`local-llm-14-2026.exe`** — установщик / лаунчер под репозиторий **`local-llm-14-2026`**
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:059669,100:10B981&height=80&section=footer&text=Made%20for%20local-llm-14-2026&fontSize=22&fontColor=fff" width="100%">
</p>
